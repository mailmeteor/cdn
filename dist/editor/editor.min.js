...
goog.editor.plugins.ImageHandler.prototype.safeInsertPlaceholder_=function(a){a&&a.id&&a["data-src"]&&(this.safeInsertImage_({id:a&&a.id,width:a&&a.width,height:a&&a.height,name:a&&a.name,src:"data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7","data-src":a["data-src"],"data-placeholder":!0}),a=this.getImageById(a.id))&&(a.style.background='#EFF1F2 url("https://ssl.gstatic.com/ui/v1/icons/mail/inline_image_placeholder.png") center center no-repeat',a.style.backgroundSize=
