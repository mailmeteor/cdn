...
goog.editor.plugins.ImageDataReplacer.prototype.detectDataUri_=function(a){if(a)try{var b=a.getElement();if(b){var c=[];b.querySelectorAll("img").forEach(function(a){0!==a.src.indexOf("data:image/")||a.getAttribute("data-placeholder")||c.push(a.src)});c.length&&this.eventHandler_(goog.editor.plugins.ImageDataReplacer.Events.IMAGE_DATA_DETECTED,{matches:c})}}catch(d){}};
...
goog.ui.MenuItem.prototype.getPreferredAriaRole=function(){return this.isSupportedState(goog.ui.Component.State.CHECKED)?goog.a11y.aria.Role.MENU_ITEM_CHECKBOX:this.isSupportedState(goog.ui.Component.State.SELECTED)?goog.a11y.aria.Role.MENU_ITEM_RADIO:goog.ui.MenuItem.superClass_.getPreferredAriaRole.call(this)};goog.ui.MenuItem.prototype.getParent=function(){return goog.ui.Control.prototype.getParent.call(this)};goog.ui.MenuItem.prototype.getParentEventTarget=function(){return goog.ui.Control.prototype.getParentEventTarget.call(this)};goog.userAgent.platform={};
...
goog.positioning.flipCornerVertical=function(a){return a^goog.positioning.CornerBit.BOTTOM};goog.positioning.flipCorner=function(a){return a^goog.positioning.CornerBit.BOTTOM^goog.positioning.CornerBit.RIGHT};goog.ui.MenuSeparator=function(a){goog.ui.Separator.call(this,goog.ui.MenuSeparatorRenderer.getInstance(),a)};goog.inherits(goog.ui.MenuSeparator,goog.ui.Separator);goog.ui.registry.setDecoratorByClassName(goog.ui.MenuSeparatorRenderer.CSS_CLASS,function(){return new goog.ui.Separator});goog.ui.Container=function(a,b,c){goog.ui.Component.call(this,c);this.renderer_=b||goog.ui.ContainerRenderer.getInstance();this.orientation_=a||this.renderer_.getDefaultOrientation()};goog.inherits(goog.ui.Container,goog.ui.Component);goog.tagUnsealableClass(goog.ui.Container);goog.ui.Container.EventType={AFTER_SHOW:"aftershow",AFTER_HIDE:"afterhide"};goog.ui.Container.Orientation={HORIZONTAL:"horizontal",VERTICAL:"vertical"};goog.ui.Container.prototype.keyEventTarget_=null;
...
goog.editor.plugins.ImageHandler.prototype.safeInsertImage_=function(a){this.image={};"string"===typeof a?this.image.src=a:(this.image.id="string"===typeof a.id&&a.id||void 0,this.image.src="string"===typeof a.src&&a.src||void 0,this.image.width="number"===typeof a.width&&a.width||void 0,this.image.height="number"===typeof a.height&&a.height||void 0,this.image.name="string"===typeof a.name&&a.name||void 0,this.image["data-src"]="string"===typeof a["data-src"]&&a["data-src"]||void 0,this.image["data-placeholder"]=
"string"===typeof a["data-placeholder"]&&a["data-placeholder"]||void 0);"string"===typeof this.image.src&&this.getFieldObject().manipulateDom(this.insertImage_,!1,this)};
...
goog.editor.plugins.ImageHandler.prototype.safeInsertPlaceholder_=function(a){a&&a.id&&a["data-src"]&&(this.safeInsertImage_({id:a&&a.id,width:a&&a.width,height:a&&a.height,name:a&&a.name,src:"data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7","data-src":a["data-src"],"data-placeholder":"true"}),a=this.getImageById(a.id))&&(a.style.background='#EFF1F2 url("https://ssl.gstatic.com/ui/v1/icons/mail/inline_image_placeholder.png") center center no-repeat',a.style.backgroundSize=
"contains",a.style.borderRadius="4px")};goog.editor.plugins.ImageHandler.prototype.safeReplacePlaceholder_=function(a){"string"===typeof a.id&&(a=this.getImageById(a.id))&&(a.src=a.getAttribute("data-src"),a.removeAttribute("id"),a.removeAttribute("data-src"),a.removeAttribute("data-placeholder"),a.removeAttribute("style"))};goog.editor.plugins.ImageHandler.prototype.safeRemovePlaceholder_=function(a){"string"===typeof a.id&&(a=this.getImageById(a.id),goog.dom.removeNode(a))};
