...
goog.ui.editor.LinkDialog.prototype.createOkEvent=function(){var a=this.dom.getElement(goog.ui.editor.LinkDialog.Id_.LINK_TO_INPUT).value;if(goog.editor.Link.isLikelyEmailAddress(a))return this.createOkEventFromEmailTab_(goog.ui.editor.LinkDialog.Id_.LINK_TO_INPUT);0>a.search(/:/)&&(a="https://"+goog.string.trimLeft(a));0===a.search(/https?:\/\/https?:\/\//)&&(a=a.replace(/https?:\/\/(https?:\/\/)/,"$1"));if(a)return this.createOkEventFromUrl_(a)};goog.ui.editor.LinkDialog.NO_FOLLOW_REGEX_=/\bnofollow\b/i;
